        ...
        <Grid container 
          sx={{
           ...
           <Grid item xs={12} sm={10} md={6} lg={5} sx={{display:'flex',flexDirection:'column',paddingTop:{md:1},paddingInline:{md:4,lg:0}, gap:{md:0,xl:4}, backgroundColor:'greenYello'}}>
                ...
                <Grid item md={12}  sx={{backgroundColor:'greenYello',width: {md:'90%',lg:'75%'},alignSelf:{md:'center'},
                 padding:{xs:2}, paddingBottom:{sm:4,md:0}}}>

                  <Typography  sx={{fontSize:{xs:26, md:22,lg:26}, fontWeight:600, marginTop:{md:1, lg:3} }} >
                    Sign in
                  </Typography>
            ...
            <Grid item sm={6} md={6} lg={5} sx={{ backgroundColor:'re',alignSelf:{md:'center'},display: { xs: 'none', sm:'none',md:'flex', justifyContent:'center'} }} >
              <Box sx={{
